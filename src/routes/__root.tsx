...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nave Desenvolvimento OS" },
      { name: "description", content: "Sistema de gestão do consultório Nave Desenvolvimento" },
      { property: "og:title", content: "Nave Desenvolvimento OS" },
      { name: "twitter:title", content: "Nave Desenvolvimento OS" },
      { property: "og:description", content: "Sistema de gestão do consultório Nave Desenvolvimento" },
      { name: "twitter:description", content: "Sistema de gestão do consultório Nave Desenvolvimento" },
